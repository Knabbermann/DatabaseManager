...
{
    public class IndexModel(IUnitOfWork unitOfWork, IToastNotification toastNotification, IEnumerable<Models.Order> orders, IConfiguration configuration) : CustomPageModel<IndexModel>(configuration)
    {
